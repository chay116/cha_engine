...
FramebufferUPtr Framebuffer::Create(const std::vector<TextureSPtr>& colorAttachments) {
...
bool Framebuffer::InitWithColorAttachments(const std::vector<TextureSPtr>& colorAttachments) {
...
CubeFramebufferUPtr CubeFramebuffer::Create(const CubeTextureSPtr colorAttachment, uint32_t mipLevel) {
...
bool CubeFramebuffer::InitWithColorAttachment(const CubeTextureSPtr& colorAttachment, uint32_t mipLevel) {
